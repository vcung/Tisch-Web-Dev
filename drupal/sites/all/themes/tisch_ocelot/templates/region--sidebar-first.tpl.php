...
<?php if ($is_front): ?>
  <section class="<?php print $classes; ?>">
    ...
    <a href="http://www.library.tufts.edu/tisch/hours.htm">More
      ...
      <ul>
    <li><span class="white shadow" data-icon="&#xe00b;" aria-hidden="true"></span> Chat  <span class="thickChevron"  aria-hidden="true">&raquo;</span></a></li>
    <li><span class="white shadow" data-icon="" aria-hidden="true">@</span> Email <span class="thickChevron" aria-hidden="true">&raquo;</span></a> </li>
    <li><span class="white shadow" data-icon="&#xe00a;" aria-hidden="true"></span> In person <span class="thickChevron" aria-hidden="true">&raquo;</span></a> </li>
    <li><span class="white shadow" data-icon="&#xe000;" aria-hidden="true"></span> Phone <span class="thickChevron" aria-hidden="true">&raquo;</span></a> </li>
    </ul>
     </div>
